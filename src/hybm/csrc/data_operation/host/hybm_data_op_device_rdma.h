...
private:
    ...
    Result BatchMergedWrite(hybm_batch_copy_params &swapParams, hybm_data_copy_direction direction, void **remote,
                            const ExtOptions &options) noexcept;
    Result BatchMergedRead(hybm_batch_copy_params &swapParams, hybm_data_copy_direction direction, void **remote,
                           const ExtOptions &options) noexcept;
