...
#ifndef MF_HYBRID_HYBM_DATA_OP_DEVICE_URMA_H
...
namespace ock {
namespace mf {
class DataOpDeviceURMA : public DataOperator {
public:
    DataOpDeviceURMA(uint32_t rankId, std::shared_ptr<transport::TransportManager> tm) noexcept;
    ~DataOpDeviceURMA() override;
...
#endif // MF_HYBRID_HYBM_DATA_OP_DEVICE_URMA_H
