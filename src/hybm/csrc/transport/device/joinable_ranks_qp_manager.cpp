...
{
    uint32_t tc = MfEnvUtil::GetOptionalUintOrDefault(env::HCCL_RDMA_TC, HCCL_RDMA_TC_DEFAULT);
    uint32_t sl = MfEnvUtil::GetOptionalUintOrDefault(env::HCCL_RDMA_SL, HCCL_RDMA_SL_DEFAULT);
