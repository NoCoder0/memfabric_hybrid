...
Result UrmaTopoRootInfoReader::ParseRootInfoStream(std::istream &input, uint32_t phyDeviceId, uint32_t rankId,
                                                   RootInfo &rootInfo)
{
    std::string buf;
...
Result UrmaTopoRootInfoReader::ParseRootInfoFile(const std::string &path, uint32_t phyDeviceId, uint32_t rankId,
                                                 RootInfo &rootInfo)
{
...
Result UrmaTopoRootInfoReader::ParseRootInfo(uint32_t phyDeviceId, uint32_t rankId, RootInfo &rootInfo)
{
    return ParseRootInfo(std::string(ROOTINFO_PATH), phyDeviceId, rankId, rootInfo);
}

Result UrmaTopoRootInfoReader::ParseRootInfo(const std::string &rootInfoPath, uint32_t phyDeviceId, uint32_t rankId,
                                             RootInfo &rootInfo)
{
