...
*/
#ifndef MF_HYBM_DEVICE_QP_COMMON_H
#define MF_HYBM_DEVICE_QP_COMMON_H
...
{
    output << "RegMemResult(size=" << mr.size << ", addr: 0x" << std::hex << mr.address << ", regAddress: 0x"
...
#endif // MF_HYBM_DEVICE_QP_COMMON_H
