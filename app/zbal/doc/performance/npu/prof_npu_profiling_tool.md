...
Key in the `chrome://tracing` and click the 'load' button to open the json file.
...
### 2.2 How add tracepoints

#### 2.2.1 Profiling Trace Detailed Usage
...
#### 2.2.2 Debug Trace Detailed Usage
