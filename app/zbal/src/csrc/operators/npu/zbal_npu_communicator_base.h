 ...
 */
#ifndef ZBAL_NPU_COMMUNICATOR_BASE_H
...
class NpuCommunicatorBase : public Communicator {
public:
    NpuCommunicatorBase(const CommGroupOptions &options, bool isWorldGroup, const CommunicatorPtr &worldGroup);
    ~NpuCommunicatorBase() override
    {
        UnInitialize();
    }
...
#endif // ZBAL_NPU_COMMUNICATOR_BASE_H
