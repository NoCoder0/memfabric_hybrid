...
#include "urma_topo_rootinfo_parser.h"
...
TEST(UrmaTopoRootInfoReaderTest, Case1_Success_Basic)
{
    std::string json = Cat({R"({"rank_list":[{"device_id":0,"level_list":[{"rank_addr_list":[{)",
                            R"("addr_type":"EID","ports":[0,1,2,3,4,5],)", R"("addr":")", EID_HEX_OK, R"("}]}]}]})"});
    std::istringstream iss(json);
    RootInfo ri;
    Result ret = UrmaTopoRootInfoReader::ParseRootInfoStream(iss, 0, 0, ri);
    EXPECT_EQ(ret, BM_OK);
...
TEST(UrmaTopoRootInfoReaderTest, Case2_Success_EidAcrossLevels)
{
    std::string json = Cat({
    ...
    std::istringstream iss(json);
    RootInfo ri;
    Result ret = UrmaTopoRootInfoReader::ParseRootInfoStream(iss, 1, 0, ri);
    EXPECT_EQ(ret, BM_OK);
}

// Case #3: Non-matching devices present
TEST(UrmaTopoRootInfoReaderTest, Case3_Success_NonMatchingDevices)
{
    std::string json = Cat({
        R"({"rank_list":[{)",
...
TEST(UrmaTopoRootInfoReaderTest, Case4_Success_NonEidAddrType)
{
    std::string json = Cat({
...
TEST(UrmaTopoRootInfoReaderTest, Case5_Success_NonSixPortPorts)
{
    std::string json = Cat({
        R"({"rank_list":[{"device_id":0,"level_list":[{)",
        R"("rank_addr_list":[{)",
...
TEST(UrmaTopoRootInfoReaderTest, Case6_Error_NoRankList)
{
...
TEST(UrmaTopoRootInfoReaderTest, Case7_Error_RankListNotArray)
{
...
TEST(UrmaTopoRootInfoReaderTest, Case8_Error_RankListElementNotObject)
{
...
TEST(UrmaTopoRootInfoReaderTest, Case9_Error_DeviceIdMissing)
{
    std::string json = Cat({
        R"({"rank_list":[{)",
...
TEST(UrmaTopoRootInfoReaderTest, Case10_Error_DeviceIdNegative)
{
    std::string json = Cat({
        R"({"rank_list":[{)",
...
TEST(UrmaTopoRootInfoReaderTest, Case11_Error_NoLevelList)
{
...
TEST(UrmaTopoRootInfoReaderTest, Case12_Error_LevelListNotArray)
{
    std::string json = Cat({
        R"({"rank_list":[{)",
...
TEST(UrmaTopoRootInfoReaderTest, Case13_Error_NoRankAddrList)
{
    std::string json = Cat({
        R"({"rank_list":[{)",
...
TEST(UrmaTopoRootInfoReaderTest, Case14_Error_RankAddrListNotArray)
{
    std::string json = Cat({
        R"({"rank_list":[{)",
...
TEST(UrmaTopoRootInfoReaderTest, Case15_Error_RankAddrNotObject)
{
    std::string json = Cat({
        R"({"rank_list":[{)",
        R"("device_id":0,"level_list":[{)",
...
TEST(UrmaTopoRootInfoReaderTest, Case18_Error_EidNoPorts)
{
    std::string json = Cat({
        R"({"rank_list":[{)",
        R"("device_id":0,"level_list":[{)",
...
TEST(UrmaTopoRootInfoReaderTest, Case19_Error_EidPortsNotArray)
{
    std::string json = Cat({
        R"({"rank_list":[{)",
        R"("device_id":0,"level_list":[{)",
...
TEST(UrmaTopoRootInfoReaderTest, Case20_Error_NoMatchingDevice)
{
    std::string json = Cat({
    ...
    std::istringstream iss(json);
    RootInfo ri;
    Result ret = UrmaTopoRootInfoReader::ParseRootInfoStream(iss, 99, 0, ri);
    EXPECT_EQ(ret, BM_INVALID_PARAM);
}

// Case #21: >1 device matches (duplicate phyDeviceId)
TEST(UrmaTopoRootInfoReaderTest, Case21_Error_DuplicateDevice)
{
    std::string json = Cat({
        R"({"rank_list":[{)",
        R"("device_id":0,"level_list":[{"rank_addr_list":[{)",
...
TEST(UrmaTopoRootInfoReaderTest, Case22_Error_NoCandidate)
{
    std::string json = Cat({
        R"({"rank_list":[{)",
        R"("device_id":0,"level_list":[{)",
...
TEST(UrmaTopoRootInfoReaderTest, Case23_Error_DuplicateCandidate)
{
    std::string json = Cat({
        R"({"rank_list":[{)",
        R"("device_id":0,"level_list":[{)",
...
TEST(UrmaTopoRootInfoReaderTest, Case24_Error_AddrMissing)
{
    std::string json = Cat({
        R"({"rank_list":[{)",
        R"("device_id":0,"level_list":[{)",
...
TEST(UrmaTopoRootInfoReaderTest, Case24b_Error_AddrMissingBeforeValid)
{
    std::string json = Cat({
        R"({"rank_list":[{)",
        R"("device_id":0,"level_list":[{)",
...
TEST(UrmaTopoRootInfoReaderTest, RankAddr_SixPortEidMissingAddr_Error)
{
...
TEST(UrmaTopoRootInfoReaderTest, Case25_Error_AddrNotString)
{
    std::string json = Cat({
        R"({"rank_list":[{)",
        R"("device_id":0,"level_list":[{)",
...
TEST(UrmaTopoRootInfoReaderTest, Case26_Error_AddrWrongLength)
{
    std::string json = Cat({
        R"({"rank_list":[{)",
        R"("device_id":0,"level_list":[{"rank_addr_list":[{)",
...
TEST(UrmaTopoRootInfoReaderTest, Case27_Error_AddrNonHex)
{
    std::string json = Cat({
        R"({"rank_list":[{)",
        R"("device_id":0,"level_list":[{"rank_addr_list":[{)",
...
TEST(UrmaTopoRootInfoReaderTest, Case28_Success_LowercaseHex)
{
    std::string json = Cat({
...
TEST(UrmaTopoRootInfoReaderTest, Case29_Success_UppercaseHex)
{
    std::string json = Cat({
        R"({"rank_list":[{"device_id":0,"level_list":[{"rank_addr_list":[{)",
        R"("addr_type":"EID","ports":[0,1,2,3,4,5],)",
...
TEST(UrmaTopoRootInfoReaderTest, Case30_Success_MixedCaseHex)
{
    std::string json = Cat({
        R"({"rank_list":[{"device_id":0,"level_list":[{"rank_addr_list":[{)",
        R"("addr_type":"EID","ports":[0,1,2,3,4,5],)",
...
TEST(UrmaTopoRootInfoReaderTest, Case31_Success_MultiLevelNoExtra)
{
    std::string json = Cat({
        R"({"rank_list":[{)",
        R"("device_id":0,"level_list":[{)",
...
TEST(UrmaTopoRootInfoReaderTest, Case32_Success_AllZeroEid)
{
    std::string json = Cat({
        R"({"rank_list":[{"device_id":0,"level_list":[{"rank_addr_list":[{)",
        R"("addr_type":"EID","ports":[0,1,2,3,4,5],)",
...
TEST(UrmaTopoRootInfoReaderTest, Case33_File_Error_NonexistentPath)
{
    RootInfo ri;
    Result ret = UrmaTopoRootInfoReader::ParseRootInfoFile("/nonexistent_path_for_test.json", 0, 0, ri);
    EXPECT_EQ(ret, BM_FILE_NOT_ACCESS);
}

// Case #34: temporary valid file
TEST(UrmaTopoRootInfoReaderTest, Case34_File_Success_TempFile)
{
    ...
    RootInfo ri;
    Result ret = UrmaTopoRootInfoReader::ParseRootInfoFile(tmpPath, 7, 0, ri);
    EXPECT_EQ(ret, BM_OK);
    const uint8_t expected[COMM_ADDR_EID_LEN] = {0xaa, 0xbb, 0xcc, 0xdd, 0xee, 0xff, 0x00, 0x11,
                                                 0x22, 0x33, 0x44, 0x55, 0x66, 0x77, 0x88, 0x99};
    ExpectEid(ri, expected);
...
TEST(UrmaTopoRootInfoReaderTest, Case35_Stream_Success_ValidJson)
{
    std::string json = Cat({
        R"({"rank_list":[{"device_id":0,"level_list":[{"rank_addr_list":[{)",
        R"("addr_type":"EID","ports":[0,1,2,3,4,5],)",
...
TEST(UrmaTopoRootInfoReaderTest, Case36_Stream_Error_Badbit)
{
...
TEST(UrmaTopoRootInfoReaderTest, Case37_Stream_Error_Empty)
{
...
TEST(UrmaTopoRootInfoReaderTest, Case38_Stream_Error_MalformedJson)
{
...
TEST(UrmaTopoRootInfoReaderTest, ADR_FailDoesNotModifyRootInfo)
{
    // rank_list missing
    {
        std::istringstream iss(R"({"other":"data"})");
...
TEST(UrmaTopoRootInfoReaderTest, ADR_LevelListBeforeDeviceId)
{
    std::string json = Cat({
        R"({"rank_list":[{)",
        R"("level_list":[{"rank_addr_list":[{)",
...
TEST(UrmaTopoRootInfoReaderTest, ADR_NonEID_NoAddrOk)
{
    std::string json = Cat({
        R"({"rank_list":[{)",
        R"("device_id":0,"level_list":[{)",
...
TEST(UrmaTopoRootInfoReaderTest, ADR_EID_BadPorts_NoAddrOk)
{
    std::string json = Cat({
        R"({"rank_list":[{)",
        R"("device_id":0,"level_list":[{)",
...
TEST(UrmaTopoRootInfoReaderTest, ADR_MultiLevelMultiCandidate)
{
    std::string json = Cat({
        R"({"rank_list":[{)",
        R"("device_id":0,"level_list":[{)",
...
TEST(UrmaTopoRootInfoReaderTest, ADR_SecondCandidateSyntaxCorruption)
{
    std::string json = Cat({
        R"({"rank_list":[{)",
        R"("device_id":0,"level_list":[{)",
...
TEST(UrmaTopoRootInfoReaderTest, ADR_TargetPostTailCorruption)
{
    std::string json = Cat({
        R"({"rank_list":[{)",
        R"("device_id":0,"level_list":[{"rank_addr_list":[{)",
...
TEST(UrmaTopoRootInfoReaderTest, Extra_Error_DeviceIdOversized)
{
    std::string json = Cat({
        R"({"rank_list":[{)",
...
TEST(UrmaTopoRootInfoReaderTest, DeviceId_NegativeZero_AsZero)
{
    std::string json = Cat({
        R"({"rank_list":[{)",
        R"("device_id":-0,"level_list":[{"rank_addr_list":[{)",
...
TEST(UrmaTopoRootInfoReaderTest, DeviceId_Negative_Rejected)
{
    std::string json = Cat({
        R"({"rank_list":[{)",
        R"("device_id":-1,"level_list":[{"rank_addr_list":[{)",
...
TEST(UrmaTopoRootInfoReaderTest, DeviceId_Float_Rejected)
{
    std::string json = Cat({
        R"({"rank_list":[{)",
...
TEST(UrmaTopoRootInfoReaderTest, DeviceId_Exponent_Rejected)
{
    std::string json = Cat({
        R"({"rank_list":[{)",
...
TEST(UrmaTopoRootInfoReaderTest, DeviceId_LeadingZero_Rejected)
{
    std::string json = Cat({
        R"({"rank_list":[{)",
...
TEST(UrmaTopoRootInfoReaderTest, DeviceId_Overflow_Rejected)
{
    std::string json = Cat({
        R"({"rank_list":[{)",
...
TEST(UrmaTopoRootInfoReaderTest, DeviceId_Zero_Ok)
{
    std::string json = Cat({
        R"({"rank_list":[{"device_id":0,"level_list":[{"rank_addr_list":[{)",
        R"("addr_type":"EID","ports":[0,1,2,3,4,5],)",
...
TEST(UrmaTopoRootInfoReaderTest, DuplicateKey_RankList_Rejected)
{
    std::string json = Cat({
        R"({"rank_list":[],)",
        R"("rank_list":[]})",
...
TEST(UrmaTopoRootInfoReaderTest, DuplicateKey_DeviceId_Rejected)
{
    std::string json = Cat({
        R"({"rank_list":[{)",
...
TEST(UrmaTopoRootInfoReaderTest, DuplicateKey_LevelList_Rejected)
{
    std::string json = Cat({
        R"({"rank_list":[{)",
...
TEST(UrmaTopoRootInfoReaderTest, DuplicateKey_RankAddrList_Rejected)
{
    std::string json = Cat({
        R"({"rank_list":[{)",
        R"("device_id":0,"level_list":[{)",
...
TEST(UrmaTopoRootInfoReaderTest, DuplicateKey_AddrType_Rejected)
{
    std::string json = Cat({
        R"({"rank_list":[{)",
        R"("device_id":0,"level_list":[{)",
...
TEST(UrmaTopoRootInfoReaderTest, DuplicateKey_Ports_Rejected)
{
    std::string json = Cat({
        R"({"rank_list":[{)",
        R"("device_id":0,"level_list":[{)",
...
TEST(UrmaTopoRootInfoReaderTest, DuplicateKey_Addr_Rejected)
{
    std::string json = Cat({
        R"({"rank_list":[{)",
        R"("device_id":0,"level_list":[{)",
...
TEST(UrmaTopoRootInfoReaderTest, TrailingGarbage_Rejected)
{
...
TEST(UrmaTopoRootInfoReaderTest, TrailingGarbage_ExtraObject_Rejected)
{
    std::string json =
...
TEST(UrmaTopoRootInfoReaderTest, Depth32_Success)
{
...
TEST(UrmaTopoRootInfoReaderTest, Depth33_Rejected)
{
    std::string inner = R"("inner")";
    for (int i = 0; i < 33; ++i) {
        inner = "[" + inner + "]";
...
TEST(UrmaTopoRootInfoReaderTest, FileSize_1MiB_Ok)
{
...
TEST(UrmaTopoRootInfoReaderTest, FileSize_1MiBPlus1_Rejected)
{
    std::string prefix = ValidPrefix();
...
TEST(UrmaTopoRootInfoReaderTest, UnknownField_ComplexValue_Ok)
{
    std::string json = Cat({
        R"({"rank_list":[{)",
        R"("device_id":1,"level_list":[{)",
...
TEST(UrmaTopoRootInfoReaderTest, UnknownField_IllegalGrammar_Rejected)
{
    std::string json = Cat({
        R"({"rank_list":[{)",
        R"("device_id":1,"level_list":[{)",
...
TEST(UrmaTopoRootInfoReaderTest, String_UnescapedControl_Rejected)
{
...
TEST(UrmaTopoRootInfoReaderTest, String_EscapeSequences_Ok)
{
...
TEST(UrmaTopoRootInfoReaderTest, String_SurrogatePair_Ok)
{
...
TEST(UrmaTopoRootInfoReaderTest, String_LoneSurrogate_Rejected)
{
...
TEST(UrmaTopoRootInfoReaderTest, String_LowSurrogate_Rejected)
{
    // Lone low surrogate \uDC00
    std::string json = Cat({
        R"({"rank_list":[{)",
...
TEST(UrmaTopoRootInfoReaderTest, Ports_ArbitraryJsonValues_Ok)
{
...
TEST(UrmaTopoRootInfoReaderTest, Ports_WrongLength_NotEidCandidate)
{
...
TEST(UrmaTopoRootInfoReaderTest, MissingComma_Object_Rejected)
{
    std::string json = Cat({
        R"({"rank_list":[{)",
        R"("device_id":0"level_list":[{"rank_addr_list":[{)",
...
TEST(UrmaTopoRootInfoReaderTest, TrailingComma_Object_Rejected)
{
    std::string json = Cat({
        R"({"rank_list":[{)",
        R"("device_id":0,"level_list":[{"rank_addr_list":[{)",
...
TEST(UrmaTopoRootInfoReaderTest, TrailingComma_Array_Rejected)
{
    std::string json = Cat({
        R"({"rank_list":[{)",
        R"("device_id":0,"level_list":[{"rank_addr_list":[{)",
...
TEST(UrmaTopoRootInfoReaderTest, IllegalArrayElement_Rejected)
{
...
TEST(UrmaTopoRootInfoReaderTest, NonTarget_DeviceIdMissing_Rejected)
{
...
TEST(UrmaTopoRootInfoReaderTest, NonTarget_DeviceIdIllegal_Rejected)
{
...
TEST(UrmaTopoRootInfoReaderTest, NonTarget_DeviceIdNegative_Rejected)
{
    std::string json = Cat({
        R"({"rank_list":[{)",
...
TEST(UrmaTopoRootInfoReaderTest, TargetThenTailRankElement_Damaged)
{
...
TEST(UrmaTopoRootInfoReaderTest, TargetThenTailLevel_Damaged)
{
...
TEST(UrmaTopoRootInfoReaderTest, TargetThenTailRankAddr_Damaged)
{
    std::string json = Cat({
        R"({"rank_list":[{)",
        R"("device_id":0,"level_list":[{)",
...
TEST(UrmaTopoRootInfoReaderTest, MissingAddrType_Rejected)
{
...
TEST(UrmaTopoRootInfoReaderTest, AddrType_WrongType_Rejected)
{
...
TEST(UrmaTopoRootInfoReaderTest, RankAddrFieldArbitraryOrder)
{
...
TEST(UrmaTopoRootInfoReaderTest, EscapedKnownKey_RankList_Rejected)
{
    std::string json = Cat({
        R"({"rank_list":[],)",
...
TEST(UrmaTopoRootInfoReaderTest, EscapedKnownKey_DeviceId_Rejected)
{
    std::string json = Cat({
        R"({"rank_list":[{)",
...
TEST(UrmaTopoRootInfoReaderTest, EscapedKnownKey_LevelList_Rejected)
{
    std::string json = Cat({
...
TEST(UrmaTopoRootInfoReaderTest, EscapedKnownKey_RankAddrList_Rejected)
{
    std::string json = Cat({
...
TEST(UrmaTopoRootInfoReaderTest, EscapedKnownKey_AddrType_Rejected)
{
    std::string json = Cat({
        R"({"rank_list":[{)",
        R"("device_id":0,"level_list":[{)",
...
TEST(UrmaTopoRootInfoReaderTest, EscapedKnownKey_Ports_Rejected)
{
    std::string json = Cat({
        R"({"rank_list":[{)",
        R"("device_id":0,"level_list":[{)",
...
TEST(UrmaTopoRootInfoReaderTest, EscapedKnownKey_Addr_Rejected)
{
    std::string json = Cat({
...
TEST(UrmaTopoRootInfoReaderTest, EscapedTargetValue_WithValidFallback_Ok)
{
...
TEST(UrmaTopoRootInfoReaderTest, Sentinel_1MiBPlus1_Unchanged)
{
    std::string prefix = ValidPrefix();
    const size_t pad = MAX_INPUT_BYTES_PLUS_1 - prefix.size();
    std::string json = prefix + std::string(pad, ' ');
...
TEST(UrmaTopoRootInfoReaderTest, Sentinel_Badbit_Unchanged)
{
    std::istringstream iss("dummy");
    iss.setstate(std::ios::badbit);
    RootInfo ri;
...
TEST(UrmaTopoRootInfoReaderTest, Sentinel_EmptyStream_Unchanged)
{
    RootInfo ri;
    ri.eid.fill(EID_SENTINEL);
...
TEST(UrmaTopoRootInfoReaderTest, LeadingWhitespace_BeforeRootBrace_Ok)
{
    std::string json =
        std::string("  \t\n ") + Cat({
                                     R"({"rank_list":[{"device_id":0,"level_list":[{"rank_addr_list":[{)",
...
TEST(UrmaTopoRootInfoReaderTest, Range_NullptrBegin)
{
    uint32_t val = 42;
...
TEST(UrmaTopoRootInfoReaderTest, Range_NullptrEnd)
{
    uint32_t val = 42;
...
TEST(UrmaTopoRootInfoReaderTest, Range_ReverseInterval)
{
    uint32_t val = 42;
    const char *data = "123";
...
TEST(UrmaTopoRootInfoReaderTest, Range_SkipString_Nullptr)
{
    ParseResult pr = SkipString(nullptr, "abc", 0, 256);
    EXPECT_EQ(pr.result, BM_INVALID_PARAM);
}

TEST(UrmaTopoRootInfoReaderTest, Range_SkipValue_Nullptr)
{
    ParseResult pr = SkipValue(nullptr, "abc", 0, 0);
    EXPECT_EQ(pr.result, BM_INVALID_PARAM);
}

TEST(UrmaTopoRootInfoReaderTest, Range_ParseSingleRankAddr_Nullptr)
{
    CandidateInfo out;
...
TEST(UrmaTopoRootInfoReaderTest, DeviceId_OutputUnchangedOnFailure)
{
...
TEST(UrmaTopoRootInfoReaderTest, DeviceId_FloatReason_Specific)
{
...
TEST(UrmaTopoRootInfoReaderTest, DeviceId_ExponentReason_Specific)
{
...
TEST(UrmaTopoRootInfoReaderTest, DeviceId_ExponentReason_CapitalE)
{
    const char *input = "1E5";
    uint32_t val = 0;
    ParseResult pr = ParseDeviceId(input, input + 3, 0, val);
...
TEST(UrmaTopoRootInfoReaderTest, DeviceId_OverflowReason_Specific)
{
...
TEST(UrmaTopoRootInfoReaderTest, DeviceId_LeadingZeroReason_Specific)
{
    const char *input = "00";
    uint32_t val = 0;
...
TEST(UrmaTopoRootInfoReaderTest, DeviceId_NegativeZeroFloat_Specific)
{
...
TEST(UrmaTopoRootInfoReaderTest, DeviceId_NegativeZeroExponent_Specific)
{
...
TEST(UrmaTopoRootInfoReaderTest, DeviceId_IllegalChar_Offset)
{
...
TEST(UrmaTopoRootInfoReaderTest, DeviceId_IllegalCharNoMinus_Offset)
{
...
TEST(UrmaTopoRootInfoReaderTest, EofOffset_UnterminatedString)
{
    const char *json = "\"abc";
...
TEST(UrmaTopoRootInfoReaderTest, EofOffset_UnterminatedObject)
{
    const char *json = "{\"a\":1";
...
TEST(UrmaTopoRootInfoReaderTest, EofOffset_UnterminatedArray)
{
    const char *json = "[1,2";
...
TEST(UrmaTopoRootInfoReaderTest, EofOffset_UnterminatedStringInObject)
{
...
TEST(UrmaTopoRootInfoReaderTest, EofOffset_UnterminatedArrayInObject)
{
    const char *json = "{\"a\":[1,";
    auto len = static_cast<size_t>(8);
    ParseResult pr = SkipValue(json, json + len, 0, 0);
...
TEST(UrmaTopoRootInfoReaderTest, DeviceUnclosed_NoClosingBrace)
{
...
TEST(UrmaTopoRootInfoReaderTest, DeviceUnclosed_EmptyObjectNoBrace)
{
    const char *json = "{";
    auto len = std::strlen(json);
    CandidateInfo out;
...
TEST(UrmaTopoRootInfoReaderTest, DeviceUnclosed_PartialObjectEof)
{
...
TEST(UrmaTopoRootInfoReaderTest, EidIllegalChar_Offset)
{
...
TEST(UrmaTopoRootInfoReaderTest, RankAddr_Unclosed_TopLevel)
{
...
TEST(UrmaTopoRootInfoReaderTest, RankAddr_ClosedAtBufferEnd_Success)
{
...
TEST(UrmaTopoRootInfoReaderTest, TrailingCommaEof_UnterminatedObject)
{
    const char *json = "{\"a\":1,";
    auto len = std::strlen(json);
    ParseResult pr = SkipValue(json, json + len, 0, 0);
...
TEST(UrmaTopoRootInfoReaderTest, Sentinel_ParseRootInfoEid_Failure)
{
    std::array<uint8_t, COMM_ADDR_EID_LEN> eid{};
    eid.fill(EID_SENTINEL);
...
TEST(UrmaTopoRootInfoReaderTest, SkipString_UnterminatedEscapeEof)
{
    const char *json = "\"abc\\";
    auto len = std::strlen(json);
    ParseResult pr = SkipString(json, json + len, 0, 256);
...
TEST(UrmaTopoRootInfoReaderTest, SkipString_Nullptr)
{
    ParseResult pr = SkipString(nullptr, "abc", 0, 256);
    EXPECT_EQ(pr.result, BM_INVALID_PARAM);
    EXPECT_EQ(pr.reason, ParserReason::BAD_VALUE);
...
TEST(UrmaTopoRootInfoReaderTest, SkipString_ReverseRange)
{
    const char *data = "abc";
...
TEST(UrmaTopoRootInfoReaderTest, Reason_ControlChar_InKey)
{
...
TEST(UrmaTopoRootInfoReaderTest, Reason_BadStringEnd_NoQuote)
{
...
TEST(UrmaTopoRootInfoReaderTest, ParseRootInfo_Atlas850UsesEightPorts)
{
    ...
    RootInfo rootInfo;
    EXPECT_EQ(UrmaTopoRootInfoReader::ParseRootInfo(rootInfoPath, 0, 0, rootInfo), BM_OK);
    EXPECT_EQ(rootInfo.eid[0], 0x01);
    std::remove(topoPath.c_str());
    std::remove(rootInfoPath.c_str());
}

TEST(UrmaTopoRootInfoReaderTest, ParseRootInfo_Atlas950UsesSixPorts)
{
...
TEST(UrmaTopoRootInfoReaderTest, ParseRootInfo_ModelPortMismatchPreservesEid)
{
    ...
    EXPECT_EQ(UrmaTopoRootInfoReader::ParseRootInfo(rootInfoPath, 0, 0, rootInfo), BM_INVALID_PARAM);
    ExpectEidSentinel(rootInfo);
    std::remove(topoPath.c_str());
    std::remove(rootInfoPath.c_str());
}

TEST(UrmaTopoRootInfoReaderTest, ParseRootInfo_TopoFileUnreadablePreservesEid)
{
    ...
    RootInfo rootInfo;
    rootInfo.eid.fill(EID_SENTINEL);
    EXPECT_EQ(UrmaTopoRootInfoReader::ParseRootInfo(rootInfoPath, 0, 0, rootInfo), BM_FILE_NOT_ACCESS);
    ExpectEidSentinel(rootInfo);
    std::remove(rootInfoPath.c_str());
}

TEST(UrmaTopoRootInfoReaderTest, ParseRootInfo_TopoFileOversizeRejected)
{
...
TEST(UrmaTopoRootInfoReaderTest, ParseRootInfo_TopoHardwareMissingPreservesEid)
{
