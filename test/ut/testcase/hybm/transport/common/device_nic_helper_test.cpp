...
#include "device_nic_helper.h"

using namespace ock::mf;
using namespace ock::mf::transport::device;

TEST(DeviceNicHelperTest, ParseDeviceNicPortRejectsInvalidAndAcceptsValid)
{
    uint16_t port = 0;
...
TEST(DeviceNicHelperTest, GenerateDeviceNicFormatsTcpUrl)
{
    in_addr ip{};
